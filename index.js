...
const quizData = [
    ...
    option1: 'Roscoe\'s',
    option2: 'Subterranean',
    option3: 'Wrigleyville North',
    option4: 'The Sixth',
    ...
    option1: 'The Field Museum of Natural History',
    option2: 'The Art Institute of Chicago',
    option3: 'The Chicago History Museum',
    option4: 'The Richard H. Driehaus Museum',
    ...
    option1: 'Maggie Daley Park',
    option2: 'Buckingham Fountain',
    option3: 'The Adler Planetarium',
    option4: 'The Sears Tower',
    ...
    option1: 'Wacker Drive Tower',
    option2: 'Trump Tower',
    option3: 'Aon Center',
    option4: 'Willis Tower',
    ...
    option1: '1: Winter (11 months) and summer (1 month)',
    option2: '4: Winter, spring, summer, and fall',
    option3: '8: Winter, colder winter, probably spring, gotcha winter, actual spring, finally summer, hot as heck, fall',
    option4: '11: Winter, fool\'s spring, second winter, spring of deception, third winter, mud season, actual spring, summer, false fall, second summer (one week), actual fall',
